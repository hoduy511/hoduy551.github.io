...
function ThoiSu(props) {
  const [allData, setAllData] = useState([]);
  useEffect(() => {
    const getAllApi = async () => {
      const response = await fetch(
        "https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fvnexpress.net%2Frss%2Fthoi-su.rss&api_key=nfqhy0dikifdplbtwpgifxpngbqefmdta0xcl429&count=55"
      );
